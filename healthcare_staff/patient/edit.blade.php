...
@section('page-desc')
    Page to edit patient data
    <br>
    <a href="{{ route('healthcare_staff.patient.index') }}" class="my-2 btn btn-sm btn-secondary me-1"><i class="fa fa-fw fa-arrow-left me-1"></i> Back</a>
@endsection

@section('page-content-title')
    <div class="row align-items-center">
        <div class="col-md">
            <h4 class="m-0 font-weight-bold text-dark"><i class="fa fa-fw fa-edit me-1" style="color:#D8201C!important;"></i> Edit Data Patient #{{ $data->username }}</h4>
        </div>
    </div>
@endsection
...
<div class="row">
    <div class="col-md">
        <form method="POST" action="{{ route('healthcare_staff.patient.update', $data->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md">
                    ...
                    <label>ICPassport</label>
                        <input type="text" class="form-control @error('ic_passport') is-invalid @enderror" name="ic_passport" value="{{ old('ic_passport', $data->ic_passport) }}">
