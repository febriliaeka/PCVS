...
class PatientController extends Controller
{
        ...
        if($request->ajax()){
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($data){
                        return actionBtn('Patient #'. $data->name, route('admin.patient.index'), route('admin.patient.show', $data->id), route('admin.patient.edit', $data->id), route('admin.patient.destroy', $data->id));
                    })
                    ->rawColumns(['action'])
                    ->make(true);
        }
        return view('admin.patient.index');
        // return redirect()->route('admin.patient.show', auth()->guard('patient')->user()->id);
    }
    ...
    public function show(Patient $patient) {
        return view('admin.patient.show', ['data' => $patient]);
    }

    public function edit(Patient $patient) {
        return view('admin.patient.edit', ['data' => $patient]);
    }
