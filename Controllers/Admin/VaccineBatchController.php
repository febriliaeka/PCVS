...
class VaccineBatchController extends Controller
{
    public function index(Request $request) {
        if($request->ajax()){
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($data){
                        return actionBtn('VaccineBatch #'. $data->name, route('admin.vaccine_batch.index'), route('admin.vaccine_batch.show', $data->id), route('admin.vaccine_batch.edit', $data->id), route('admin.vaccine_batch.destroy', $data->id));
                    })
        ...
        return view('admin.vaccine_batch.index', compact('data_healthcare_centre', 'data_vaccine'));
    }

    public function create(){
        return view('admin.vaccine_batch.create');
    }
    ...
    public function show(VaccineBatch $vaccineBatch) {
        return view('admin.vaccine_batch.show', ['data' => $vaccineBatch]);
    }

    public function edit(VaccineBatch $vaccineBatch) {
        $data_healthcare_centre = HealthcareCentre::all();
        $data_vaccine = Vaccine::all();
        return view('admin.vaccine_batch.edit', ['data' => $vaccineBatch, 'data_healthcare_centre' => $data_healthcare_centre, 'data_vaccine' => $data_vaccine]);
    }
