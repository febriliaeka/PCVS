...
class HealthcareStaffController extends Controller
{
    public function index(Request $request) {
        ...
        //                 return actionBtn('HealthcareStaff #'. $data->name, route('healthcare_staff.healthcare_staff.index'), route('healthcare_staff.healthcare_staff.show', $data->id), route('healthcare_staff.healthcare_staff.edit', $data->id), route('healthcare_staff.healthcare_staff.destroy', $data->id));
        //             })
        //             ->rawColumns(['action'])
        //             ->make(true);
        // }
        // $data_healthcare_centre = HealthcareCentre::all();
        // return view('healthcare_staff.healthcare_staff.index', compact('data_healthcare_centre'));
        return redirect()->route('healthcare_staff.healthcare_staff.show', auth()->guard('healthcare_staff')->user()->id);
    }

    public function create(){
        return view('healthcare_staff.healthcare_staff.create');
    }
    ...
    public function show(HealthcareStaff $healthcareStaff) {
        return view('healthcare_staff.healthcare_staff.show', ['data' => $healthcareStaff]);
    }

    public function edit(HealthcareStaff $healthcareStaff) {
        $data_healthcare_centre = HealthcareCentre::all();
        return view('healthcare_staff.healthcare_staff.edit', ['data' => $healthcareStaff, 'data_healthcare_centre' => $data_healthcare_centre]);
    }
