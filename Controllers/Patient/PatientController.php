...
class PatientController extends Controller
{
    public function index(Request $request) {
        ...
        //                 return actionBtn('Patient #'. $data->name, route('patient.patient.index'), route('patient.patient.show', $data->id), route('patient.patient.edit', $data->id), route('patient.patient.destroy', $data->id));
        //             })
        //             ->rawColumns(['action'])
        //             ->make(true);
        // }
        // return view('patient.patient.index');
        return redirect()->route('patient.patient.show', auth()->guard('patient')->user()->id);
    }
    ...
    public function show(Patient $patient) {
        return view('patient.patient.show', ['data' => $patient]);
    }

    public function edit(Patient $patient) {
        return view('patient.patient.edit', ['data' => $patient]);
    }
