    ...
    <div class="col-lg-8 offset-2 my-auto text-center">
        <div class="p-5">
            <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Patient Login</h1>
            </div>
            @include('components.error')
            <form method="POST" action="{{ route('auth.login_patient') }}" class="user">
                @csrf
                @method('POST')
            ...
            <div class="mt-3">
                <a href="{{ route('auth.register.form_patient') }}" class="text-muted">Sign Up</a>
            </div>
        </div>
    </div>
</div>
