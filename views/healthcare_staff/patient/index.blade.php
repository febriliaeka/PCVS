...
@section('page-desc')
    Page to manage patient data
@endsection

@section('page-content-title')
    <div class="row align-items-center">
        <div class="col-md">
            <h4 class="my-2 font-weight-bold text-dark"><i class="fa fa-fw fa-users-cog me-1"  style="color:#D8201C!important;"></i> Patient Data </h4>
        </div>
        ...
        <div class="col-12">
            <div id="insert-box">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('healthcare_staff.patient.store') }}" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="row">
                                <div class="col-md">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 my-2">
                                    <img id="preview-myimg" src="https://www.riobeauty.co.uk/images/admin_image_not_found.gif" alt="preview image" style="max-height: 400px;">
                                </div>
                            </div>
...
@section('js')
    <script>
        ...
        $('#datatables').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('healthcare_staff.patient.index') }}",
            columns: [
                {
                    data: 'id',
                    name: 'id'
