    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu px-0    ">
                ...
                {{-- <li class="sidebar-item  ">
                    <a href="{{ route('admin.healthcare_staff.index') }}" class='sidebar-link'>
                        <i style="color:#eb7974!important;" class="fa fa-fw fa-user-md"></i>
                        <span>Healthcare Staff</span>
                    </a>
                </li> --}}
                <li class="sidebar-item  ">
                    <a href="{{ route('admin.vaccine_batch.index') }}" class='sidebar-link'>
                ...
                <li class="sidebar-item  ">
                    <a href="{{ route('admin.vaccine_patient.index') }}" class='sidebar-link'>
