...
@section('page-desc')
    ...
    <br>
    <a href="{{ route('admin.vaccine_patient.index') }}" class="my-2 btn btn-sm btn-secondary me-1"><i class="fa fa-fw fa-arrow-left me-1"></i> Back</a>
@endsection
...
<div class="row">
    <div class="col-md">
        <form method="POST" action="{{ route('admin.vaccine_patient.update', $data->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md">
